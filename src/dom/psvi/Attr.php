...
class Attr extends BaseAttr
{
    ...
    protected function createValue()
    {
        ...
        if ($attrType instanceof ListType) {
             ...
             * associative array, mapping each item literal to its conversion
             * result.
             *
             * @warning This implies that repeated items will silently be
             * dropped in this case. To model lists of items having a
             * converter with possible repetition, an explicit converter for
             ...
             * enumerators, replace the value by an associative array, mapping
             * each item literal to its enumerator object.
             *
             * @warning This implies that repeated enumerators will silently
             * be dropped. To model lists of enumerators with possible
             * repetition, an explicit converter for the list type is
             * necessary.
             */
