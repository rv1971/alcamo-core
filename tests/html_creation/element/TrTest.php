...
class TrTest extends TestCase {
  ...
  public function testBasics(
    $content, $attrs, $cellClass, $expectedString
  ) {
  ...
  public function basicsProvider() {
    return [
      ...
      'Map' => [
        ...
        [ 'class' => 'important' ],
        Th::class,
        '<tr class="important"><th>43</th><script src="foo.js"></script><th>At vero eos </th><template>Lorem ipsum</template><td id="qux">baz</td></tr>',
      ],
    ];
  }
}
