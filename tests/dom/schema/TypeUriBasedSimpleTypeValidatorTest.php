        ...
        return [
            'no-errors' => [
                ...
                [
                    ...
                    [ '42 43 44', 'tests/dom/foo2.xsd#ListOfNamedItemType' ],
                    [ 'quux', 'tests/dom/foo2.xsd#FooBarType' ]
                ],
                []
            ],
            'errors' => [
                ...
                [
                    ...
                    [ '1970-01--01', 'xsd/XMLSchema.xsd#date' ],
                    [ 'ach-UG', 'xsd/XMLSchema.xsd#language' ],
                    [ '42 43 x 44', 'tests/dom/foo2.xsd#ListOfNamedItemType' ],
                    [ '42 43 44', 'tests/dom/foo2.xsd#ListOfNamedItemType' ],
                    [ 'quuux', 'tests/dom/foo2.xsd#FooBarType' ]
                ],
                [
